...
'Change every test'
WebUI.setText(findTestObject('Object Repository/Page_Add a Company UserKasikornbank/input_Email Address_email'), 'Test0003@automate.test')

WebUI.click(findTestObject('Object Repository/Page_Add a Company UserKasikornbank/div_Quicklinks                             _cc13b1'))

WebUI.takeFullPageScreenshot('C:\\Users\\PIKA\\Katalon Studio\\katalon.git\\Test Capture\\Merchant Portal KShop\\M-05 Add a Company user\\Add Company user - 1.png')

WebUI.click(findTestObject('Object Repository/Page_Add a Company UserKasikornbank/a_Submit'))

WebUI.takeFullPageScreenshot('C:\\Users\\PIKA\\Katalon Studio\\katalon.git\\Test Capture\\Merchant Portal KShop\\M-05 Add a Company user\\Add Company user - 2.png')

WebUI.click(findTestObject('Object Repository/Page_Add a Company UserKasikornbank/a_Confirm'))

WebUI.takeFullPageScreenshot('C:\\Users\\PIKA\\Katalon Studio\\katalon.git\\Test Capture\\Merchant Portal KShop\\M-05 Add a Company user\\Add Company user - 3.png')

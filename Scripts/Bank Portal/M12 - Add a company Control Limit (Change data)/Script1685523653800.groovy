...
WebUI.takeFullPageScreenshot('C:\\Users\\PIKA\\Katalon Studio\\katalon.git\\Test Capture\\Bank Potal\\M-12 Add a company Control Limit\\Add A Company (EDC) - No Input.png')
...
'Change Every test'
WebUI.setText(findTestObject('Object Repository/Page_Add A Company (EDC)Kasikornbank/input_Merchant ID (MID)_mid'), '998877688877002')
...
WebUI.takeFullPageScreenshot('C:\\Users\\PIKA\\Katalon Studio\\katalon.git\\Test Capture\\Bank Potal\\M-12 Add a company Control Limit\\Add A Company (EDC) - 1.png')

WebUI.click(findTestObject('Object Repository/Page_Add A Company (EDC)Kasikornbank/a_Submit'))

WebUI.takeFullPageScreenshot('C:\\Users\\PIKA\\Katalon Studio\\katalon.git\\Test Capture\\Bank Potal\\M-12 Add a company Control Limit\\Add A Company (EDC) - 2.png')

WebUI.click(findTestObject('Object Repository/Page_Add A Company (EDC)Kasikornbank/a_Confirm'))

WebUI.takeFullPageScreenshot('C:\\Users\\PIKA\\Katalon Studio\\katalon.git\\Test Capture\\Bank Potal\\M-12 Add a company Control Limit\\Add A Company (EDC) - 3.png')

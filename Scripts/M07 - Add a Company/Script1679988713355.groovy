...
WebUI.setText(findTestObject('Object Repository/Page_Add a CompanyKasikornbank/input_Company Name_businessName'), 'TestAutomate03')
...
'Change every run test'
WebUI.setText(findTestObject('Object Repository/Page_Add a CompanyKasikornbank/input_Email Address_email'), 'Testautomate003@test.test')
...
'Change every run test'
WebUI.setText(findTestObject('Object Repository/Page_Add a CompanyKasikornbank/input_Merchant ID (MID)_mid'), '123564565673222')
